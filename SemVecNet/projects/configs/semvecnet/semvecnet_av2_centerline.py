...
data = dict(
    ...
    val=dict(
        ...
        map_ann_file=data_root + 'av2_gt_map_anns_val_maptr2.json',
        # code_size=3,
        z_cfg=z_cfg,
...
lr_config = dict(
    ...
    min_lr_ratio=1e-3)
total_epochs = 150
evaluation = dict(interval=1, pipeline=test_pipeline, metric='chamfer', save_best='AV2Map_chamfer/mAP', rule='greater')
# total_epochs = 50
