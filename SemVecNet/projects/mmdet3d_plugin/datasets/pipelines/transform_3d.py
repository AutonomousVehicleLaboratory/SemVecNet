...
@PIPELINES.register_module()
class NormalizeSemanticMap(object):
    """Normalize the image.
    ...
    def __call__(self, results):
        ...
        Returns:
            dict: Normalized results, 'img_norm_cfg' key is added into
                result dict.
        """
        results['sem_map'] = mmcv.imnormalize(results['sem_map'], self.mean, self.std, self.to_rgb)
...
class CustomCollect3D(object):
    ...
    def __call__(self, results):
        ...
        # data['sem_filename'] = DC(results['sem_filename'], cpu_only=True)
