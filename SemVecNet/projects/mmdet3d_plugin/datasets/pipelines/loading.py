...
class CustomLoadSemanticMapFromFile(object):
    ...
    def __call__(self, results):
        """Call function to load semantic map from file.

        Args:
            results (dict): Result dict containing semantic filename.

        Returns:
            dict: The result dict containing the semantic map data. \
        ...
        results['sem_map'] = img
        results['sem_map_shape'] = img.shape
        return results
...
# @PIPELINES.register_module()
# class CustomLoadSemanticMapFromFile(object):
#     """Load Semantic Map from File Argoverse2.
...
#         Args:
#             results (dict): Result dict containing Semantic Map and filenames.

#         Returns:
#             dict: The result dict containing the multi-view image data. \
#                 Added keys and values are described below.

#                 - filename (str): Semantic Map filename.
#                 - img (np.ndarray): Semantic Map Image array.
#                 - img_shape (tuple[int]): Shape of Semantic Map Image array.
#                 - ori_shape (tuple[int]): Shape of original image array.
#                 - pad_shape (tuple[int]): Shape of padded image array.
#                 - scale_factor (float): Scale factor.
#                 - img_norm_cfg (dict): Normalization configuration of images.
#         """
#         filename = results['img_filename']
