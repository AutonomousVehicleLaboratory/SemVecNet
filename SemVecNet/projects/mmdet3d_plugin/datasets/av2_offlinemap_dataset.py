...
class CustomAV2SemanticMapDataset(CustomNuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def vectormap_pipeline(self, example, input_dict):
        ...
        anns_results = self.vector_map.gen_vectorized_samples(input_dict['annotation'] if 'annotation' in list(input_dict.keys()) else input_dict['ann_info'],
    ...
    def union2one(self, queue):
        ...
        """
        if len(queue) > 0 and 'img' in queue[0]:
    ...
    def get_semantic_map_path(self, image_path):
        ...
        if self.modality['use_camera']:
            ...
            for cam_type, cam_info in info['cams'].items():
                if cam_type == "ring_front_center":
                    sem_path = self.get_semantic_map_path(cam_info['img_fpath'])
...
@DATASETS.register_module()
class CustomAV2SemanticMapDatasetSingle02(CustomNuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def get_semantic_map_path(self, image_path):
        if "train" in str(image_path):
            new_path = str(image_path).replace("/cogrob-avl-dataset/argoverse2/sensor/train", "/cogrob-avl-dataset/argoverse2/sensor/train_segmented_map_single_02")
            new_path = new_path.replace(".jpg", ".png")
            return new_path
        elif "val" in str(image_path):
            new_path = str(image_path).replace("/cogrob-avl-dataset/argoverse2/sensor/val", "/cogrob-avl-dataset/argoverse2/sensor/val_segmented_map_single_02")
            new_path = new_path.replace(".jpg", ".png")
            return new_path
        elif "test" in str(image_path):
            new_path = str(image_path).replace("/cogrob-avl-dataset/argoverse2/sensor/test", "/cogrob-avl-dataset/argoverse2/sensor/test_segmented_map_single_02")
            new_path = new_path.replace(".jpg", ".png")
            return new_path
...
@DATASETS.register_module()
class CustomAV2SemanticMapDataset01(CustomNuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def get_semantic_map_path(self, image_path):
        if "train" in str(image_path):
            new_path = str(image_path).replace("/cogrob-avl-dataset/argoverse2/sensor/train", "/cogrob-avl-dataset/argoverse2/sensor/train_segmented_map_01")
            new_path = new_path.replace(".jpg", ".png")
            return new_path
        elif "val" in str(image_path):
            new_path = str(image_path).replace("/cogrob-avl-dataset/argoverse2/sensor/val", "/cogrob-avl-dataset/argoverse2/sensor/val_segmented_map_01")
            new_path = new_path.replace(".jpg", ".png")
            return new_path
        elif "test" in str(image_path):
            new_path = str(image_path).replace("/cogrob-avl-dataset/argoverse2/sensor/test", "/cogrob-avl-dataset/argoverse2/sensor/test_segmented_map_01")
            new_path = new_path.replace(".jpg", ".png")
            return new_path
...
@DATASETS.register_module()
class CustomAV2SemanticMapSubsetDataset(CustomNuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def load_annotations(self, ann_file):
        ...
        # import pdb;pdb.set_trace()
        data_infos = list(sorted(data['samples'], key=lambda e: e['timestamp']))
        data_infos = data_infos[:400:self.load_interval]
        # data_infos = [ data_info.update(dict(token= str(data_info['timestamp']+data_info['log_id'])))  for data_info in data_infos]
        self.metadata = None
        self.version = None
        return data_infos
