...
class MapTRPerceptionTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        if modality == 'vision' or modality == 'fusion':
        ...
        Returns:
            tuple[Tensor]: results of decoder containing the following tensor.
                ...
                - enc_outputs_coord_unact: The regression results \
                    ...
                    otherwise None.
        """
        if self.modality == 'sem_map' or mlvl_feats is None:
            sem_map_feat = nn.functional.interpolate(sem_map_feat, size=(bev_h,bev_w), mode='bicubic', align_corners=False)
            bev_embed = sem_map_feat.flatten(2).permute(0,2,1).contiguous()
            depth = None
        else:
